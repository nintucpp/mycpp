...
int main(int argc, char** argv)
{
  ...
  try {
    ...
    //------------------------------------------------------------------------
    cerr<<"Before calling CServiceA_i Neelendra" <<endl;
    CServiceA_i* myRequestServiceA = new CServiceA_i();
     cerr<<"after calling CServiceA_i Neelendra" <<endl;                                                                            
    //------------------------------------------------------------------------
    ...
    //------------------------------------------------------------------------
     cerr<<"Before calling myRequestServiceA_oid Neelendra" <<endl;
    PortableServer::ObjectId_var myRequestServiceA_oid
                                = _poa->activate_object(myRequestServiceA);
      cerr<<"after calling myRequestServiceA_oid Neelendra" <<endl;                                                                          
    //------------------------------------------------------------------------
    ...
    //------------------------------------------------------------------------
     cerr<<"Before calling object_to_string Neelendra" <<endl;
    CORBA::String_var sior(orb->object_to_string(SA_obj.in()));
    cerr << "'" << (char*)sior << "'" << endl;
     cerr<<"after calling object_to_string Neelendra" <<endl;                                                                            
    //========================================================================
    ...
    cerr<<"Neelendra 1" <<endl;
    cerr << "Caught CORBA::SystemException." << endl;
  }
  catch(CORBA::Exception&) {
    cerr<<"Neelendra 12" <<endl;
